...
public class ViewAnimasi extends View{
    ...
    public void onSizeChanged(int w, int h, int oldw, int oldh) {
        @SuppressLint("ObjectAnimatorBinding") ObjectAnimator membesar = ObjectAnimator.ofFloat(this,
                "radius", 0, getWidth());
        membesar.setDuration(DURASI);
        membesar.setInterpolator(new LinearInterpolator());
        @SuppressLint("ObjectAnimatorBinding") ObjectAnimator mengecil = ObjectAnimator.ofFloat(this,
                "radius", getWidth(), 0);
        mengecil.setDuration(DURASI);
        mengecil.setInterpolator(new LinearOutSlowInInterpolator());
        mengecil.setStartDelay(DELAY);
        @SuppressLint("ObjectAnimatorBinding") ObjectAnimator ulang = ObjectAnimator.ofFloat(this,
                "radius", 0, getWidth());
